...
function loadLevel(levelNum) {
    ...
    map.createFromObjects('BoxStoppers_RIGHT', 32, 'boxStopper_RIGHT', 0, true, false, boxStoppers);
    map.createFromObjects('BoxStoppers_LEFT', 32, 'boxStopper_LEFT', 0, true, false, boxStoppers);
